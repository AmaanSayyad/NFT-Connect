...
console.log(selectedAddress);
  ...
  async function Notification(owner,address,number) {
    console.log(owner);
    ...
    try {
      const apiResponse = await PushAPI.payloads.sendNotification({
        ...
        notification: {
          title: "Wohooo!!🎉🥳",
          body: `Somebody might be interest in your NFT address this ${address} with tokenId ${number}`,
        },
        payload: {
          title: "Wohooo!!🎉🥳",
          body: `Somebody might be interest in your NFT address this ${address} with tokenId ${number}`,
...
const provider = new ethers.providers.AlchemyProvider(
  "mainnet",
  "LOMa0tTRRfWpgIftxpCXwCkCHd4OrEyN"
);
...
console.log(address)
    ...
    console.log("data5");
    //  Notification(owner, address, number);
  }
